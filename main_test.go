...
func TestShortenedUrlHandler(t *testing.T) {
	...
	t.Run("redirect code", func(t *testing.T) {
	...
	t.Run("default redirect location header", func(t *testing.T) {
		req := httptest.NewRequest("GET", "http://example.com/source", nil)
		w := httptest.NewRecorder()
		router.ServeHTTP(w, req)
		resp := w.Result()
	...
	t.Run("missing slug redirect code", func(t *testing.T) {
	...
	t.Run("no slug mux var", func(t *testing.T) {
...
func Test_checkPassword(t *testing.T) {
	...
	t.Run("login middleware success", func(t *testing.T) {
		req := httptest.NewRequest("GET", "http://example.com/test", nil)
		req.SetBasicAuth("username", "abc")
	...
	t.Run("login middleware fail", func(t *testing.T) {
		req := httptest.NewRequest("GET", "http://example.com/test", nil)
